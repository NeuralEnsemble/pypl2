...
class PyPL2FileReader:
    ...
    def pl2_get_last_error(self, buffer, buffer_size):
        ...
        self.result = self.pl2_dll.PL2_GetLastError(ctypes.byref(buffer), ctypes.c_int(buffer_size))
    ...
    def pl2_get_analog_channel_info(self, zero_based_channel_index, pl2_analog_channel_info):
        ...
        self.result = self.pl2_dll.PL2_GetAnalogChannelInfo(self.file_handle, ctypes.c_int(zero_based_channel_index), ctypes.byref(pl2_analog_channel_info))
    ...
    def pl2_get_analog_channel_info_by_name(self, channel_name, pl2_analog_channel_info):
        ...
        self.result = self.pl2_dll.PL2_GetAnalogChannelInfoByName(self.file_handle, channel_name.encode('ascii'), ctypes.byref(pl2_analog_channel_info))

        return self.result
        
    def pl2_get_analog_channel_info_by_source(self, source_id, one_based_channel_index_in_source, pl2_analog_channel_info):
        """
        Retrieve information about an analog channel
        ...
        self.result = self.pl2_dll.PL2_GetAnalogChannelInfoBySource(self.file_handle, ctypes.c_int(source_id), ctypes.c_int(one_based_channel_index_in_source), ctypes.byref(pl2_analog_channel_info))

        return self.result        
        
    def pl2_get_analog_channel_data(self, zero_based_channel_index, num_fragments_returned, num_data_points_returned, fragment_timestamps, fragment_counts, values):
        """
    ...
    def pl2_get_analog_channel_data_by_name(self, channel_name, num_fragments_returned, num_data_points_returned, fragment_timestamps, fragment_counts, values):
        """
        Retrieve analog channel data
        ...
        self.result = self.pl2_dll.PL2_GetAnalogChannelDataByName(self.file_handle, channel_name.encode('ascii'), ctypes.byref(num_fragments_returned), ctypes.byref(num_data_points_returned), ctypes.byref(fragment_timestamps), ctypes.byref(fragment_counts), ctypes.byref(values))
        
        return self.result
     
    def pl2_get_analog_channel_data_by_source(self, source_id, one_based_channel_index_in_source, num_fragments_returned, num_data_points_returned, fragment_timestamps, fragment_counts, values):
        """
        Retrieve analog channel data
        ...
        self.result = self.pl2_dll.PL2_GetAnalogChannelDataBySource(self.file_handle, ctypes.c_int(source_id), ctypes.c_int(one_based_channel_index_in_source), ctypes.byref(num_fragments_returned), ctypes.byref(num_data_points_returned), ctypes.byref(fragment_timestamps), ctypes.byref(fragment_counts), ctypes.byref(values))
    ...
    def pl2_get_spike_channel_info(self, zero_based_channel_index, pl2_spike_channel_info):
        ...
        self.result = self.pl2_dll.PL2_GetSpikeChannelInfo(self.file_handle, ctypes.c_int(zero_based_channel_index), ctypes.byref(pl2_spike_channel_info))
    ...
    def pl2_get_spike_channel_info_by_name(self, channel_name, pl2_spike_channel_info):
        ...
        self.result = self.pl2_dll.PL2_GetSpikeChannelInfoByName(self.file_handle, channel_name.encode('ascii'), ctypes.byref(pl2_spike_channel_info))
        
        return self.result
    
    def pl2_get_spike_channel_info_by_source(self, source_id, one_based_channel_index_in_source, pl2_spike_channel_info):
        """
        Retrieve information about a spike channel
        ...
        self.result = self.pl2_dll.PL2_GetSpikeChannelInfoBySource(self.file_handle, ctypes.c_int(source_id), ctypes.c_int(one_based_channel_index_in_source), ctypes.byref(pl2_spike_channel_info))
        
        return self.result        
    
    def pl2_get_spike_channel_data(self, zero_based_channel_index, num_spikes_returned, spike_timestamps, units, values):
        """
    ...
    def pl2_get_spike_channel_data_by_name(self, channel_name, num_spikes_returned, spike_timestamps, units, values):
        """
        Retrieve spike channel data
        ...
        self.result = self.pl2_dll.PL2_GetSpikeChannelDataByName(self.file_handle, channel_name.encode('ascii'), ctypes.byref(num_spikes_returned), ctypes.byref(spike_timestamps), ctypes.byref(units), ctypes.byref(values))
        
        return self.result
        
    def pl2_get_spike_channel_data_by_source(self, source_id, one_based_channel_index_in_source, num_spikes_returned, spike_timestamps, units, values):
        """
        Retrieve spike channel data
        ...
        self.result = self.pl2_dll.PL2_GetSpikeChannelDataBySource(self.file_handle, ctypes.c_int(source_id), ctypes.c_int(one_based_channel_index_in_source), ctypes.byref(num_spikes_returned), ctypes.byref(spike_timestamps), ctypes.byref(units), ctypes.byref(values))
    ...
    def pl2_get_digital_channel_info(self, zero_based_channel_index, pl2_digital_channel_info):
        ...
        self.result = self.pl2_dll.PL2_GetDigitalChannelInfo(self.file_handle, ctypes.c_int(zero_based_channel_index), ctypes.byref(pl2_digital_channel_info))
    ...
    def pl2_get_digital_channel_info_by_name(self, channel_name, pl2_digital_channel_info):
        ...
        self.result = self.pl2_dll.PL2_GetDigitalChannelInfoByName(self.file_handle, channel_name_buffer, ctypes.byref(pl2_digital_channel_info))
        
        return self.result
        
    def pl2_get_digital_channel_info_by_source(self, source_id, one_based_channel_index_in_source, pl2_digital_channel_info):
        """
        Retrieve information about a digital event channel
        ...
        self.result = self.pl2_dll.PL2_GetDigitalChannelInfoBySource(self.file_handle, ctypes.c_int(source_id), ctypes.c_int(one_based_channel_index_in_source), ctypes.byref(pl2_digital_channel_info))
        
        return self.result
    
    def pl2_get_digital_channel_data(self, zero_based_channel_index, num_events_returned, event_timestamps, event_values):
        """
        ...
        self.result = self.pl2_dll.PL2_GetDigitalChannelData(self.file_handle, ctypes.c_int(zero_based_channel_index), ctypes.byref(num_events_returned), ctypes.byref(event_timestamps), ctypes.byref(event_values))
        
        return self.result
        
    def pl2_get_digital_channel_data_by_name(self, channel_name, num_events_returned, event_timestamps, event_values):
        """
        Retrieve digital even channel data
        ...
        self.result = self.pl2_dll.PL2_GetDigitalChannelDataByName(self.file_handle, channel_name_buffer, ctypes.byref(num_events_returned), ctypes.byref(event_timestamps), ctypes.byref(event_values))
        
        return self.result        
        
    def pl2_get_digital_channel_data_by_source(self, source_id, one_based_channel_index_in_source, num_events_returned, event_timestamps, event_values):
        """
        Retrieve digital even channel data
        ...
        self.result = self.pl2_dll.PL2_GetDigitalChannelDataBySource(self.file_handle, ctypes.c_int(source_id), ctypes.c_int(one_based_channel_index_in_source), ctypes.byref(num_events_returned), ctypes.byref(event_timestamps), ctypes.byref(event_values))
    ...
    def pl2_get_start_stop_channel_info(self, number_of_start_stop_events):
        ...
        self.result = self.pl2_dll.PL2_GetStartStopChannelInfo(self.file_handle, ctypes.byref(number_of_start_stop_events))
    ...
    def pl2_get_start_stop_channel_data(self, num_events_returned, event_timestamps, event_values):
        ...
        self.result = self.pl2_dll.PL2_GetStartStopChannelData(self.file_handle, ctypes.byref(num_events_returned), ctypes.byref(event_timestamps), ctypes.byref(event_values))
